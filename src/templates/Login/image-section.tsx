export default function ImageSection() {
  return (
    <section className="bg-children-face-of-africa hidden xl:flex h-[750px] px-7 py-10 rounded-xl text-white overflow-hidden gap-3 flex-col  justify-end w-[90%] max-w-[600px] bg-cover ">
